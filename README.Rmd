...
Since this is the by far the most common way of using `copies()`, version 0.0.0.9023 of `elucidate` also introduced a convenience wrapper called `dupes()` for the above:
