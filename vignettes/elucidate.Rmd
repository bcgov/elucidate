...
```{r plot_histogram_grouped_alpha}
pdata |> 
  plot_histogram(x = y1, fill_var = g, 
                 alpha = 0.8) #80% opaque
```
...
```{r plot_raincloud_custom_grouped}
pdata |> 
